...
year: 2010
type: journalArticle
citekey: schmolkeEcologicalModelsSupporting2010
...
#Modelling-cycle, #📜, #good_modelling_practice, #TRACE

[Open Zotero Entry](zotero://open-pdf/library/items/AHNY9GZV)[Read PDF in Zotero](zotero://open-pdf/library/items/M9D5QSED)
...
#### Imported on 2025-11-16 7:10 pm


>[!quote] Quote
Ecological models are developed for different purposes: exploration of ideas and theories, demonstration of concepts, understanding of general principles and patterns, predictions of ecosystem behaviors, and many more [15,16]. [(p. 479)](zotero://open-pdf/library/items/M9D5QSED?page=479&annotation=5IGMEA4Q)

>[!quote] Image
![[04_Literature/library/images/schmolkeEcologicalModelsSupporting2010/image-3-x46-y36.png]]

>[!quote] Quote
The format of TRACE documentations follows the sequence of tasks in the modeling cycle (Figure 2). Accordingly, this format can also be used for modeling notebooks; [(p. 483)](zotero://open-pdf/library/items/M9D5QSED?page=483&annotation=4PISFUYT)
